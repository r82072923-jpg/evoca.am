...
const MrcanaknerNewsiMasin2 = () => {
  ...
  useEffect(() => {
    const fetchBankingNews = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, "mrcanaknernewsiMasin"));
        const data = [];
...
export default MrcanaknerNewsiMasin2;