      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="lg:w-1/2 space-y-5 z-10 pl-0 lg:pl-4">
            ...
            Տեքստիլ ոլորտում հումքի<br className="hidden sm:block" />
            ներմուծմանն ուղղված վարկ
            </h1>
            
            <p className="text-[#595959] text-[15px] sm:text-base leading-[1.6] max-w-[500px]">
            Evocabank-ը տրամադրում է բիզնես վարկ՝ տեքստիլ հումքի ներմուծման համար։ Շտապեք 
            դիմել, զարգացնել Ձեր բիզնեսը և դառնալ ոլորտում մրցունակ։
            </p>
          </div>
          ...
          <div className="lg:w-1/2 relative flex justify-center lg:justify-end w-full pr-0 lg:pr-4">
            ...
            <div className="relative z-10 w-full max-w-[560px]">
              <img
                src="https://www.evoca.am/images-cache/loans/1/17749381045647/560x400.png"
...
export default BusinessLoan2iMasin;