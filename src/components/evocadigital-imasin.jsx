...
import EvocaDigital from './evocadigital';
const EvocaDigitaliMasin = () => {
  const articleData = {
    category: "Պրոդուկտներ",
    categoryPath: "/news/products",
    title: "Evoca Digital քարտեր",
    description: "Թվային ապագան Evoca-ում է․ EvocaTOUCH հավելվածում արդեն կարող ես ձեռք բերել Evoca Digital քարտերը՝ քո նախընտրած դիզայնով։",
    url: "https://www.evoca.am/images-cache/news/1/16868326578274/780x585.png" 
  };
...
export default EvocaDigitaliMasin;