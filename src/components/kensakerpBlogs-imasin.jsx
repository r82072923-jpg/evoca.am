...
const KensakerpBlogsiMasin = () => {
  const articleData = {
    category: "Կենսակերպ",
    categoryPath: "/blog/business-lifestyle",
    title: "Տարին սկսենք պլանավորելով",
    description: "Նոր տարի, նոր սկիզբ և հնարավորություն դառնալու ավելի լավը:",
    url: "https://www.evoca.am/images-cache/blogs/1/164138504886/780x585.png" 
  };
...
export default KensakerpBlogsiMasin;