...
const HarcazruycnerNewsiMasin = () => {
  const articleData = {
    category: "Հարցազրույցներ",
    categoryPath: "/news/interviews",
    title: "Կարեն Եղիազարյանի նոր հարցազրույցը Banks.am-ին",
    description: "Կարեն Եղիազարյան․ «Բանկային ոլորտում լավագույն AI-ը անտեսանելի է»։ Evocabank-ի Վարչության նախագահի նոր հարցազրույցն արդեն հասանելի է Banks.am կայքում։",
    url: "https://www.evoca.am/images-cache/news/1/17845396816254/780x585.png" 
  };
...
export default HarcazruycnerNewsiMasin;