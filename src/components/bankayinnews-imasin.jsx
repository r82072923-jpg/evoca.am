...
const BankayinNewsiMasin = () => {
  const articleData = {
    category: "Բանկային",
    categoryPath: "/news/lifestyle",
    title: "Ba3 վարկանիշ Moody’s-ից Evocabank-ին",
    description: "Evocabank-ը Moody’s-ից ստացել է Ba3 վարկանիշ՝ դրական հեռանկարով, որը համապատասխանում է Հայաստանի սուվերեն վարկանիշին։",
    url: "https://www.evoca.am/images-cache/news/1/17870544210976/780x585.png" 
  };
...
export default BankayinNewsiMasin;