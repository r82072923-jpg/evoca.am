...
function MasterCardStandardiMasin() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="lg:w-1/2 space-y-5 z-10 pl-0 lg:pl-4">
            ...
            Աշխարհի ցանկացած կետում, որտեղ էլ լինես, քո ֆինանսական միջոցները 24/7 սկզբունքով հասանելի կլինեն։
            </p>
          </div>
...
export default MasterCardStandardiMasin;