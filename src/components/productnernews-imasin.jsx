...
const ProductnerNewsiMasin = () => {
  const articleData = {
    category: "Պրոդուկտներ",
    categoryPath: "/news/interviews",
    title: "Դեպի նոր ուսումնական տարի՝ մինչև 23% cashback-ով",
    description: "Մինչև սեպտեմբերի 15-ը վճարիր Evoca Mastercard-ով ակցիայի մասնակից խանութներում և գրախանութներում ու ստացիր մինչև 23% cashback։",
    url: "https://www.evoca.am/images-cache/news/1/17873217684586/780x585.png" 
  };
    ...
    <div className="w-full bg-[#fcfcfd] py-16 px-6 font-sans">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="flex-1 w-full relative pl-4 pt-4">
          ...
          <div className="absolute top-0 left-0 w-12 h-12 border-t-[6px] border-l-[6px] border-[#FF00FF]"></div>
...
export default ProductnerNewsiMasin;