    ...
    accordions: [
      {
        ...
        type: "table",
        rows: [
          ["1", "Արժույթ", "ՀՀ դրամ կամ արտարժույթ"],
          ["2", "Պահանջվող ապահովվածություն", "Պահանջվող ապահովված"],
          ["3", "Ապահովվածներ", "Պահանջվող ապահովված"],
          ["4", "Երաշխիքի բողոքարկման իսկական հաստատում/ուղարկում", "Պահանջվող ապահովված"],
          ["5", "Երաշխիքի պայմանների փոփոխման խոշորացում/երկարաձգում", "0.1%Ն, նվազ. 10,000 ՀՀ դրամ"],
          ["6", "Երաշխիքի մանրացում", "0.1%Ն, նվազ. 10,000 ՀՀ դրամ"],
          ["7", "Հաճախի կողմից բողոքարկման իսկական հաստատման/երաշխիքով վճարում", "0.1%Ն, նվազ. 10,000 ՀՀ դրամ"],
          ["8", "Երաշխիքի իմաս կանչում", "50,000 ՀՀ դրամ"]
        ]
      },
      {
        ...
        rows: [
          ["1", "Արժույթ", "ՀՀ դրամ կամ արտարժույթ"],
          ["2", "Տրամադրման ժամկետայնություն", "Պայմանագրային"],
          ["3", "Ժամկետանցներ", "Մինչև 60 օրվա ժամկետանցով"],
          ["4", "Կանխավճար վճարման", "Իրավաբանական անձանց և անհատ ձեռնարկատերերին տրամադրվող երաշխիքների դեպքում, եթե պահանջվող ապահովվածությամբ ապահովվող երաշխիքի արժեքրացման փաստացի կամ առևտրի ժամանակահատվածի համար չի օգտագործվում 70,000 ՀՀ դրամ, ապա միջնորդավճարից միանվագ վճար 20,000 ՀՀ դրամի արժեքի չափով"],
          ["5", "Փոփոխման/երկարացում", "5,000 ՀՀ դրամ"],
          ["6", "Շարժական գույքի գրավով/ոչ բանկային ապահովվածության դեպքում", "1 %Ն"],
          ["7", "Շարժական գույքի գրավով այլ ապահովվածության դեպքում", "2 %Ն"],
          ["8", "Ճշգրոտ երաշխիքում", "25,000 ՀՀ դրամ"],
          ["9", "Վճարում պահանջի դիմաց", "0.4%, նվազ. 10,000 ՀՀ դրամ"],
          ["10", "Վարկի դասակարգման դեպքում", "Ոչ ավելի քան ՀՀ Կենտրոնական բանկի սահմանված բանկային տոկոսի հաշվարկային տոկոսադրույքի կրկնապատիկ"]
        ]
      },
      {
        ...
        rows: [
          ...
          ["2", "Տրամադրման ժամկետայնություն", "Պայմանագրային"],
          ["3", "Ժամկետանցներ", "Մինչև 60 օրվա ժամկետանցով"],
          ["4", "Ապահովվածություն", "Դրամական միջոցների հաշվարկային հաշվի կամ ընթացիկ հաշվի մնացորդ, ինչպես նաև Բանկի կողմից թողարկված պարտատոմսեր, պետական պարտատոմսեր"],
          ["5", "Կանխավճար վճարման", "Իրավաբանական անձանց և անհատ ձեռնարկատերերին տրամադրվող երաշխիքների դեպքում, եթե պահանջվող ապահովվածությամբ ապահովվող երաշխիքի արժեքրացման փաստացի կամ առևտրի ժամանակահատվածի համար չի օգտագործվում 70,000 ՀՀ դրամ, ապա միջնորդավճարից միանվագ վճար 20,000 ՀՀ դրամի արժեքի չափով"],
          ["6", "Փոփոխման/երկարացում", "5,000 ՀՀ դրամ"],
          ["7", "Տարեկան տոկոսադրույք", "1 %Ն"],
          ["8", "Ճշգրոտ երաշխիքում", "25,000 ՀՀ դրամ"],
          ["9", "Վճարում պահանջի դիմաց", "0.4%, նվազ. 10,000 ՀՀ դրամ"],
          ["10", "Վարկի դասակարգման դեպքում", "Ոչ ավելի քան ՀՀ Կենտրոնական բանկի սահմանված բանկային տոկոսի հաշվարկային տոկոսադրույքի կրկնապատիկ"]
        ]
      ...
      },
      {
        ...
        rows: [
          ["1", "Արժույթ", "ՀՀ դրամ կամ արտարժույթ"],
          ["2", "Տրամադրման սահմանափակում", "Ապահովվող անշարժ գույքի շուկայական/գնահատված արժեքի երկրապատիկի չափով"],
          ["3", "Ժամկետանցներ", "Մինչև 60 ամիս ժամկետով"],
          ...
          ["5", "Ապահովվածություն", "Բանկի համար ընդունելի անշարժ գույք"],
          ["6", "Տարեկան տոկոսադրույք", "1.0%"],
          ["7", "Ճշգրոտ երաշխիքում", "25,000 ՀՀ դրամ"],
          ["8", "Վճարում պահանջի դիմաց", "0.4%, նվազ. 10,000 ՀՀ դրամ"],
          ["9", "Վարկի դասակարգման դեպքում", "ՀՀ Կենտրոնական բանկի սահմանված բանկային տոկոսի հաշվարկային տոկոսադրույքի կրկնապատիկի չափով"]
        ]
      }
    ]
  };
