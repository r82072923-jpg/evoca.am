...
function ArcaClassiciMasin2({ activeTab, setActiveTab }) {
  ...
  useEffect(() => {
    const fetchTariffs = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, "arcaClassiciMasin"));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-7 text-[#1a1a1a] text-lg sm:text-xl leading-relaxed">
            <p>
              ArCa Classic քարտը «Արմենիան Քարդ» վճարային համակարգի կողմից թողարկվող լոկալ վճարային քարտ է, որը հնարավոր է օգտագործել միայն ՀՀ տարածքում:
            </p>
            <p>
              ArCa Classic վճարային քարտով դու կկարողանաս վճարումներ կատարել ՀՀ տարածքում գործող առևտրի և սպասարկման կետերում, դրամական միջոցներ կանխիկացնել ATM-ից, օնլայն գնումներ և վճարումներ կատարել ArCa տարբերանշանը կրող ինտերնետային կայքերում, EvocaTOUCH հավելվածի միջոցով իրականացնել կոմունալ վճարումներ, փոխանցումներ և մի շարք այլ վճարումներ։
            </p>
            <p>
              Պատվիրիր ArCa Classic քարտը EvocaTOUCH հավելվածի միջոցով, և մենք անվճար կառաքենք այն ՀՀ ողջ տարածքում։
            </p>
          </div>
...
export default ArcaClassiciMasin2;