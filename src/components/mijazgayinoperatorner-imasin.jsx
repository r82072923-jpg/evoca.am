...
const MijazgayinOperatorneriMasin = () => {
  ...
  useEffect(() => {
    const fetchOrganizations = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, "mijazgayinoperatorneriMasin"));
        const data = [];
...
export default MijazgayinOperatorneriMasin;