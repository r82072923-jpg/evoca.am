...
function VisaInfiniteCardiMasin3({ activeTab, setActiveTab }) {
  ...
  useEffect(() => {
    // Այստեղ կարող ես միացնել Firebase-ը, իսկ առայժմ աշխատում է ուղղակի աղյուսակային կառուցվածքով
    setLoading(false);
  }, []);
  ...
  return (
    <section className="w-full bg-white py-12 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Վերնագիր և նկարագրություն աղյուսակի վերևում */}
        <div className="max-w-5xl mb-8 space-y-4">
          <h3 className="text-xl sm:text-2xl font-extrabold text-[#6b11cb]">
            Visa Infinite վճարային քարտով տրամադրվող վարկային սահմանաչափ
          </h3>
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            Մեր Visa Infinite գործընկերները կարող են ստանալ հատուկ արտոնյալ պայմաններով վարկային սահմանաչափ։ Սահմանաչափի համար կարելի է դիմել EvocaTOUCH հավելվածի միջոցով, շաբաթվա բոլոր օրերին և ցանկացած ժամի՝ առանց հավելյալ թղթաբանության ու ժամանակ կորցնելու կամ այցելել Բանկի գլխավոր գրասենյակ կամ ցանկացած մասնաճյուղ։
          </p>
        </div>

        {/* Աղյուսակ (ճշգրիտ նկարի տեսքով) */}
          ...
          <table className="w-full border-collapse text-left">
            ...
            <tbody className="divide-y divide-[#e5d9f2] text-gray-800 text-sm sm:text-base">
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-medium">300,000 ՀՀ դրամ</td>
              </tr>
              ...
              {/* Կից քարտի տարեկան սպասարկում (բաժանված ենթատողերով) */}
              <tr>
                ...
                <td className="py-3 px-6 border-b border-[#e5d9f2] flex justify-between items-center">
                  ...
                  <span className="font-semibold">70,000 ՀՀ դրամ</span>
                </td>
              </tr>
              <tr>
              ...
              {/* Քարտային հաշվի դրական մնացորդ... գլխամասային տող */}
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-medium">1.5%</td>
              </tr>
...
<tr>
                ...
                <td className="py-3 px-6 border-b border-[#e5d9f2] flex justify-between items-center">
                  ...
                  <span className="font-semibold text-lg text-[#6b11cb]">1%</span>
                </td>
              </tr>
              <tr>
                <td className="py-3 px-6 border-b border-[#e5d9f2] flex justify-between items-center">
                  <span className="text-gray-600">ԱՄՆ դոլար և եվրո</span>
                  <span className="font-semibold text-lg text-[#6b11cb]">1% <sup className="text-xs text-[#6b11cb]">[3]</sup></span>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-semibold text-lg text-[#6b11cb]">
                  1.2% <sup className="text-xs text-[#6b11cb]">[5]</sup>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-semibold text-lg text-[#6b11cb]">
                  1.5% min 2,500 ՀՀ դրամ <sup className="text-xs text-[#6b11cb]">[7]</sup>
                </td>
              </tr>

              {/* Բանկի տարածքում կանխիկի տրամադրում */}
              <tr>
                <td className="py-4 px-6 border-r border-[#e5d9f2] font-medium" rowSpan="3">
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-medium">1,000 ՀՀ դրամ</td>
              </tr>
...
<tr>
                ...
                <td className="py-4 px-6 font-medium">30,000 ՀՀ դրամ</td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-semibold text-lg text-[#6b11cb]">1.2%</td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-semibold text-lg text-[#6b11cb]">0.5%</td>
              </tr>

              <tr>
                <td className="py-4 px-6 border-r border-[#e5d9f2] font-medium">Գերածախսի գծով տույժեր</td>
                <td className="py-4 px-6 font-medium">20% տարեկան</td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-semibold text-lg text-[#6b11cb]">1%</td>
              </tr>
<tr>
                <td className="py-4 px-6 border-r border-[#e5d9f2] pl-10 font-medium">
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-semibold text-lg text-[#6b11cb]">5,000,000 ՀՀ դրամ</td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-medium">մինչև 500,000 ՀՀ դրամ (կախված է ԱԳՄ-ից)</td>
              </tr>
